...
public class Utils {
    ...
    public void dispatchTakePictureIntent(Intent intent,PackageManager packageManager, File file, Context context,Uri uri) {//packagemanager=>getPackageManager() //file=>getExternalFilesDir(Environment.DIRECTORY_PICTURES) //context=>this//uri=>photoUri
      //  Intent takePictureIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        ...
        if (intent.resolveActivity(packageManager) != null) {
            ...
            if (photoFile != null) {
                uri = FileProvider.getUriForFile(context,//TODO
