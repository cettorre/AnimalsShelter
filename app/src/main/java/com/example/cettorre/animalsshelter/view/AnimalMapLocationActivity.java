...
public class AnimalMapLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng latlng = new LatLng(animalDTO.getLatitude(), animalDTO.getLongitude());

        mMap.addMarker(new MarkerOptions().position(latlng).title("Name: "+animalDTO.getName()+" Type: "+animalDTO.getType()));
